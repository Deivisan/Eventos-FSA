...
![EventosFSA](https://img.shields.io/badge/EventosFSA-Documenta%C3%A7%C3%A3o%20Completa-DC2626?style=for-the-badge)
...
|------------|-----------|
| ![](screenshots/01-homepage.png) | **Homepage** - Página inicial com eventos destaque |
| ![](screenshots/04-eventos.png) | **Eventos** - Lista de todos os eventos da cidade |
| ![](screenshots/05-artistas.png) | **Artistas** - Catálogo com ranking e gorjetas |
| ![](screenshots/06-estabelecimentos.png) | **Bares** - Lista de locais com música ao vivo |

### Interfaces de Login/Cadastro

| Screenshot | Descrição |
|------------|-----------|
| ![](screenshots/02-login.png) | **Login** - Acesso ao sistema |
| ![](screenshots/03-cadastro.png) | **Cadastro** - Formulário inteligente |

### Dashboards (Áreas Logadas)

| Screenshot | Descrição |
|------------|-----------|
| ![](screenshots/07-admin-dashboard.png) | **Admin** - Painel administrativo completo |
| ![](screenshots/08-artista-dashboard.png) | **Artista** - Área do artista |
| ![](screenshots/09-estabelecimento-dashboard.png) | **Bar/Restaurante** - Painel do dono |

### Páginas de Perfil

| Screenshot | Descrição |
|------------|-----------|
| ![](screenshots/10-artista-perfil.png) | **Perfil Artista** - Página pública completa |
| ![](screenshots/11-portal-qrcode.png) | **Portal QR** - O que o cliente vê no bar! |
...
![Made with ❤️](https://img.shields.io/badge/Made%20with-%E2%9D%A4%EF%B8%8F-DC2626)
